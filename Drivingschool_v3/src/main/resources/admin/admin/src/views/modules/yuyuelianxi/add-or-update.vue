<template>
	<div class="addEdit-block" :style='{"padding":"10px 30px"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="Coach account" prop="jiaolianzhanghao">
					<el-input v-model="ruleForm.jiaolianzhanghao" placeholder="Coach account" clearable  :readonly="ro.jiaolianzhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="Coach account" prop="jiaolianzhanghao">
					<el-input v-model="ruleForm.jiaolianzhanghao" placeholder="Coach account" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="Coach Name" prop="jiaolianxingming">
					<el-input v-model="ruleForm.jiaolianxingming" placeholder="Coach Name" clearable  :readonly="ro.jiaolianxingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="Coach Name" prop="jiaolianxingming">
					<el-input v-model="ruleForm.jiaolianxingming" placeholder="Coach Name" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="Contact Number" prop="lianxidianhua">
					<el-input v-model="ruleForm.lianxidianhua" placeholder="Contact Number" clearable  :readonly="ro.lianxidianhua"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="Contact Number" prop="lianxidianhua">
					<el-input v-model="ruleForm.lianxidianhua" placeholder="Contact Number" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="date" v-if="type!='info'" label="time of appointment" prop="yuyueshijian">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-else-if="ruleForm.yuyueshijian" label="time of appointment" prop="yuyueshijian">
					<el-input v-model="ruleForm.yuyueshijian" placeholder="time of appointment" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="Appointment remarks" prop="yuyuebeizhu">
					<el-input v-model="ruleForm.yuyuebeizhu" placeholder="Appointment remarks" clearable  :readonly="ro.yuyuebeizhu"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="Appointment remarks" prop="yuyuebeizhu">
					<el-input v-model="ruleForm.yuyuebeizhu" placeholder="Appointment remarks" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="select" v-if="type!='info'"  label="Practice subjects" prop="lianxikemu">
					<el-select :disabled="ro.lianxikemu" v-model="ruleForm.lianxikemu" placeholder="Please select Practice subjects" >
						<el-option
							v-for="(item,index) in lianxikemuOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="Practice subjects" prop="lianxikemu">
					<el-input v-model="ruleForm.lianxikemu"
						placeholder="Practice subjects" readonly></el-input>
				</el-form-item>
			</template>
	...
	data() {
		...
		return {
			...
			rules: {
				...
				lianxikemu: [
					{ required: true, message: 'Practice subjectsCannot be empty', trigger: 'blur' },
				],
				sfsh: [
				],
				shhf: [
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='lianxikemu'){
							this.ruleForm.lianxikemu = obj[o];
							this.ro.lianxikemu = true;
							continue;
						}
				}
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					 ...
					 this.$http({
					   url: `yuyuelianxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yuyuelianxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
