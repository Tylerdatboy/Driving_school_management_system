<template>
	<div class="addEdit-block" :style='{"padding":"10px 30px"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="Name of driving school" prop="jiaxiaomingcheng">
					<el-input v-model="ruleForm.jiaxiaomingcheng" placeholder="Name of driving school" clearable  :readonly="ro.jiaxiaomingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="Name of driving school" prop="jiaxiaomingcheng">
					<el-input v-model="ruleForm.jiaxiaomingcheng" placeholder="Name of driving school" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="contact information" prop="lianxifangshi">
					<el-input v-model="ruleForm.lianxifangshi" placeholder="contact information" clearable  :readonly="ro.lianxifangshi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="contact information" prop="lianxifangshi">
					<el-input v-model="ruleForm.lianxifangshi" placeholder="contact information" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="Driving school address" prop="jiaxiaodizhi">
					<el-input v-model="ruleForm.jiaxiaodizhi" placeholder="Driving school address" clearable  :readonly="ro.jiaxiaodizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="Driving school address" prop="jiaxiaodizhi">
					<el-input v-model="ruleForm.jiaxiaodizhi" placeholder="Driving school address" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="tuition fee" prop="xuefei">
					<el-input v-model="ruleForm.xuefei" placeholder="tuition fee" clearable  :readonly="ro.xuefei"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="tuition fee" prop="xuefei">
					<el-input v-model="ruleForm.xuefei" placeholder="tuition fee" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="date" v-if="type!='info'" label="registration time" prop="baomingshijian">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-else-if="ruleForm.baomingshijian" label="registration time" prop="baomingshijian">
					<el-input v-model="ruleForm.baomingshijian" placeholder="registration time" readonly></el-input>
				</el-form-item>
			</template>
	...
	data() {
		...
		return {
			...
			rules: {
				...
				jiaxiaodizhi: [
					{ required: true, message: 'Driving school addressCannot be empty', trigger: 'blur' },
				],
				xueyuanzhanghao: [
				],
				xueyuanxingming: [
				...
				xuefei: [
					{ required: true, message: 'tuition feeCannot be empty', trigger: 'blur' },
