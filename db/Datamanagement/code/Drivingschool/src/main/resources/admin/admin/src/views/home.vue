...
<div class="content" :style='{"width":"100%","padding":"30px","background":"url(http://codegen.caihongy.cn/20221130/95ab6b2e322c4d18a548562ba480af2a.png) no-repeat center bottom","height":"100vh"}'>
	<div class="text" :style='{"margin":"20px auto 40px","fontSize":"32px","color":"#333","textAlign":"center","background":"none","fontWeight":"bold"}'>Welcome to use {{this.$project.projectName}}</div>
</div>
</template>
<script>
//0
