	...
	<div class="addEdit-block" :style='{"padding":"10px 30px"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="Practice subjects" prop="lianxikemu">
					<el-input v-model="ruleForm.lianxikemu" placeholder="Practice subjects" clearable  :readonly="ro.lianxikemu"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="Practice subjects" prop="lianxikemu">
					<el-input v-model="ruleForm.lianxikemu" placeholder="Practice subjects" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label=" evaluate" prop="pingjia">
					<el-input v-model="ruleForm.pingjia" placeholder=" evaluate" clearable  :readonly="ro.pingjia"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label=" evaluate" prop="pingjia">
					<el-input v-model="ruleForm.pingjia" placeholder=" evaluate" readonly></el-input>
				</el-form-item>
			</template>
		...
		init(id,type) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					var json = data.data;
					if(((json.xueyuanzhanghao!=''&&json.xueyuanzhanghao) || json.xueyuanzhanghao==0) && this.$storage.get("role")!="admin"){
						this.ruleForm.xueyuanzhanghao = json.xueyuanzhanghao
						this.ro.xueyuanzhanghao = true;
					}
					if(((json.xueyuanxingming!=''&&json.xueyuanxingming) || json.xueyuanxingming==0) && this.$storage.get("role")!="admin"){
						this.ruleForm.xueyuanxingming = json.xueyuanxingming
						this.ro.xueyuanxingming = true;
					}
					if(((json.xueyuanshouji!=''&&json.xueyuanshouji) || json.xueyuanshouji==0) && this.$storage.get("role")!="admin"){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					 ...
					 this.$http({
					   url: `jiaolianpingjia/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiaolianpingjiaCrossAddOrUpdateFlag = false;
						 this.parent.search();
