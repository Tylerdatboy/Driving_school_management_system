	...
	<div class="addEdit-block" :style='{"padding":"10px 30px"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="textarea" v-if="type!='info'" label="Brief Introduction" prop="introduction">
					<el-input
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else-if="ruleForm.introduction" label="Brief Introduction" prop="introduction">
	...
	data() {
		...
		return {
			...
			rules: {
				...
				picture: [
					{ required: true, message: '图片Cannot be empty', trigger: 'blur' },
				],
				content: [
